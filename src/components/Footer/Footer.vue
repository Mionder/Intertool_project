		...
		<div class="layout-center clearfix">
			<div class="field-content">
				<div class="block-title">
					Подпишитесь на НОВОСТИ INTERTOOL <br> получите 5% скидку
				</div>
			...
			<div class="field-content">
				...
				<div class="contact field-block">
					...
					<div class="tel">
						...
						<a href="tel:+38 (050) 355-70-07">+38 (050) 355-70-07</a>
						<a href="tel:+38 (044) 221-70-07">+38 (044) 221-70-07</a>
					</div>
					<div class="find">
				...
				<div class="mobile">
					...
					<div class="field-call">
						...
						<div class="follow">
							<div class="label">Подпишитесь на нас</div>
		...
		<div class="layout-center clearfix">
			<div class="field-content">
				...
				<div class="field-block rights">
					intertool.ua - все права защищены. | <a href="">Условия использования сайта</a> | <a href="">Карта сайта</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="wrap">
			...
			<div class="head-cart">
				<div class="layout-center">
					<div class="head"><div>Корзина</div> <div class="close"></div></div>
				</div>
			</div>
			...
			<div class="layout-center clearfix">
				...
				<div id="main-content" class="no-sidebar clearfix">
						...
						<div id="cart">
							<div class="field-content">
								<div class="row row-1">
									<div class="col col-1">
										<div class="field-img">
											<img src="dist/images/c1.png">
										</div>
									</div>
									<div class="col col-2">
										<div class="field-title">Компрессор 50 л, 3 кВт, 220 В, 8 атм, 420 л/мин, 2 цилиндра. INTERTOOL PT-0007</div>
										<div class="art"><div class="label">Артикул:</div>PT-0010</div>
										<div class="price">
											<div class="price-old">2,799 грн.</div>
											<div class="price-new">1 009 грн.</div>
										</div>
										<div class="bonus">
											+119.95 бонусов
										</div>
							...
							<div class="total-summ">
								...
								<div class="col-2">
									<div class="field field-bonus">+230.95 бонусов</div>
									<div class="field field-old-price">688 грн.</div>
									<div class="field field-new-price">4000 грн.</div>
								</div>
							</div>
					...
					<!-- сюда пихаем item-list переключалки на след. страницы -->
